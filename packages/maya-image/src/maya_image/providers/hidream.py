"""fal provider for HiDream-O1-Image edit/generate."""
...
class FalHiDreamO1ImageProvider(FalBaseImageProvider):
    _GENERATE_ENDPOINT = "fal-ai/hidream-o1-image"
    _EDIT_ENDPOINT = "fal-ai/hidream-o1-image/edit"
